...
function questionThreeIntermediate() {
    ...
    function findMiddleValue(arr)  {
        if (arr.length % 2 != 0) {
            ...
            let arrMiddle = (arrLength - 1) / 2;
            return arrMiddle;
        }
    }


    musicGenres.splice(findMiddleValue(musicGenres), 1, "Classics");
    console.log(musicGenres);
    ...
    makeEven(musicGenres);
    console.log(musicGenres);

    musicGenres.splice(0, 0, "Rap", "Reggae");
    console.log(musicGenres);
}
...
//REATTEMPT WITH NEW ARRAY/STRING KNOWLEDGE!!!
        ...
        let newStr = "";
            if (str) {
                ...
                for (let i in splitStr){
                    console.log(i);
                    if(i > 0){
                      newStr += splitStr[i].charAt(0).toUpperCase() + splitStr[i].slice(1);
                      console.log(newStr);
                    }else{
                      newStr += splitStr[i]
                      console.log(newStr);
...
function questionFiveIntermediate() {
    ...
    //             let split = str.split(' '),
    //             // num1 = +split[0],
    //             numOne = Number(split[0]),
    //             oper = split[1],
    //             // num2 = +split[2],
    //             num2 = Number(split[2]);

    //             if (!this.methods[oper]  ||  isNaN(numOne)  ||  isNaN(num2))  {
    //                 return NaN;
    //             }

    //             return this.methods[oper](numOne, num2);
    //         };
...
function questionSixIntermediate() {
    function unique(arr) {
        //Write code here
            ...
            let newArray = Array.from(noDouble);
            return newArray;
